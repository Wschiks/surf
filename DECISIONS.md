...
- **Layout: the four levels of every sport now sit next to each other in one row** (left to right, Level 1 to 4) instead of a 2 x 2 block with two levels underneath. Skimboarding and wave surfing share the Wave area side by side, the three Sea sports each get a strip of the Sea, and sailing runs across the Ocean (Level 1 on the left). The reef and Nazaré landmarks, the jetty and the cove were moved to fit. (I read "the west" as "the rest"; if you meant something else, tell me.)
