...
export const SPORTS: SportDef[] = [
    ...
    levels: [
      {
        ...
        rect: { x: 5.9, y: 1.7, w: 1.95, h: 2.25 },
        tier: 0,
        baseGuests: 3,
        baseSeconds: 6,
        look: 'rolling',
      },
      {
        ...
        rect: { x: 7.89, y: 1.7, w: 1.95, h: 2.25 },
        tier: 1.6,
        baseGuests: 4,
        baseSeconds: 8,
        look: 'rolling',
      ...
      },
      {
        ...
        rect: { x: 9.88, y: 1.7, w: 1.95, h: 2.25 },
        tier: 3.2,
        baseGuests: 3,
        baseSeconds: 10,
        look: 'reef',
      ...
      },
      {
        ...
        rect: { x: 11.87, y: 1.7, w: 1.95, h: 2.25 },
        tier: 4.8,
        baseGuests: 2,
        baseSeconds: 12,
        look: 'big',
  ...
  },
  {
    ...
    levels: [
      ...
      },
      {
        ...
        rect: { x: 1.35, y: 1.7, w: 1.2, h: 2.25 },
        tier: 1.4,
        baseGuests: 4,
        baseSeconds: 8,
        look: 'flat',
      ...
      },
      {
        ...
        rect: { x: 3.85, y: 1.7, w: 1.2, h: 2.25 },
        tier: 4.0,
        baseGuests: 2,
        baseSeconds: 11,
        look: 'bigbreak',
    ...
    levels: [
      {
        ...
        rect: { x: 0.05, y: 4.05, w: 1.2, h: 2.25 },
        tier: 4.4,
        baseGuests: 4,
        baseSeconds: 7,
        look: 'flat',
      },
      {
        ...
        rect: { x: 1.27, y: 4.05, w: 1.2, h: 2.25 },
        tier: 5.4,
        baseGuests: 4,
        baseSeconds: 8,
        look: 'ripple',
      ...
      },
      {
        ...
        rect: { x: 2.49, y: 4.05, w: 1.2, h: 2.25 },
        tier: 6.6,
        baseGuests: 3,
        baseSeconds: 9,
        look: 'chop',
      ...
      },
      {
        ...
        rect: { x: 3.71, y: 4.05, w: 1.2, h: 2.25 },
        tier: 7.8,
        baseGuests: 2,
        baseSeconds: 11,
        look: 'big',
    ...
    levels: [
      {
        ...
        rect: { x: 5.05, y: 4.05, w: 1.2, h: 2.25 },
        tier: 5.0,
        baseGuests: 4,
        baseSeconds: 8,
        look: 'flat',
      },
      {
        ...
        rect: { x: 6.27, y: 4.05, w: 1.2, h: 2.25 },
        tier: 6.0,
        baseGuests: 4,
        baseSeconds: 8,
        look: 'ripple',
      ...
      },
      {
        ...
        rect: { x: 7.49, y: 4.05, w: 1.2, h: 2.25 },
        tier: 7.2,
        baseGuests: 3,
        baseSeconds: 10,
        look: 'chop',
      ...
      },
      {
        ...
        rect: { x: 8.71, y: 4.05, w: 1.2, h: 2.25 },
        tier: 8.4,
        baseGuests: 2,
        baseSeconds: 12,
        look: 'big',
    ...
    levels: [
      {
        ...
        rect: { x: 10.05, y: 4.05, w: 1.2, h: 2.25 },
        tier: 5.6,
        baseGuests: 4,
        baseSeconds: 9,
        look: 'flat',
      },
      {
        ...
        rect: { x: 11.27, y: 4.05, w: 1.2, h: 2.25 },
        tier: 6.6,
        baseGuests: 4,
        baseSeconds: 9,
        look: 'flat',
      ...
      },
      {
        ...
        rect: { x: 12.49, y: 4.05, w: 1.2, h: 2.25 },
        tier: 7.8,
        baseGuests: 3,
        baseSeconds: 11,
        look: 'swell',
      ...
      },
      {
        ...
        rect: { x: 13.71, y: 4.05, w: 1.2, h: 2.25 },
        tier: 9.0,
        baseGuests: 2,
        baseSeconds: 13,
        look: 'big',
  ...
  },
  {
    ...
    beachSite: { id: 'jetty', name: 'Jetty', rect: { x: 5.25, y: 0.9, w: 0.5, h: 2.2 } },
    terms: {
      capacity: 'More boats',
      price: 'Level up',
