...
export const EXPANSIONS: ExpansionDef[] = [
  { n: 1, name: 'Beach expansion', opens: 'sea', blurb: 'Opens the Sea: windsurfing, kitesurfing and foil and wing.', level: 4, coins: unlockCoins(6.2, 150) },
  { n: 2, name: 'Grand beach expansion', opens: 'ocean', blurb: 'Opens the Ocean: sailing and boats.', level: 4, coins: unlockCoins(10.0, 150) },
];
