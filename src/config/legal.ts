...
export const TERMS: LegalSection[] = [
  ...
  { title: '2. Free to play and the shop', body: 'The game is free to play. In the phone apps you can choose to watch video ads for bonuses (gems, coins x2), and you can buy two optional one-time items in the shop: "Remove ads" and "Coins x5". The price is shown in the shop in your own currency. Purchases are paid through the App Store or Google Play, are for your own use on your own account, and can be restored with "Restore purchases" in the shop. Refunds follow the rules of the store you bought from. Coins, gems and everything else in the game have no value outside the game and cannot be exchanged for money.' },
...
export const PRIVACY: LegalSection[] = [
  ...
  { title: 'Purchases', body: 'Payments for "Remove ads" and "Coins x5" are handled entirely by Apple or Google. We never see your name, card or other payment details. The game only learns whether the store says you own an item, and remembers that on your device.' },
