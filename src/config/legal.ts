...
export const PRIVACY: LegalSection[] = [
  ...
  { title: 'Purchases', body: 'Payments for gem packs, "Remove ads" and "Coins x5" are handled entirely by Apple or Google. We never see your name, card or other payment details. The game only learns whether the store says you own an item, and remembers that on your device.' },
