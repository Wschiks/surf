...
export type FacilityEffect = 'coins' | 'speed';
...
export const FACILITIES: FacilityDef[] = [
  ...
  { id: 'lifeguard', name: 'Lifeguard tower', icon: 'lifeguard', blurb: 'Safe beaches bring in more guests who spend more.', effect: 'coins', perLevel: 0.08, max: 8, baseCost: 18000, growth: 5.4, at: { x: 12.8, y: 0.3 } },
];
